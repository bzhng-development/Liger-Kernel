...
def main():
    ...
    if args.with_liger:
        try:
            ...
            print("[Info] Applied Liger Gemma3n text patch (AltUp + Laurel + RMSNorm + 3n-RoPE + fused CE)")
        except Exception as e:
    ...
    if args.with_liger:
        try:
            ...
            print("[Info] Patched Gemma3n model instance with Liger (text-only, AltUp + Laurel + 3n-RoPE + fused CE)")
        except Exception as e:
